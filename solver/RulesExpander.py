...
class RulesExpander:
    ...
    def expand(self, marking: bool, operator: str, subformulas: list[str]) -> tuple[tuple[str, bool]] | tuple[str, bool]:
    ...
    def __reversing_polarity(self, marking: bool, alpha: str) -> tuple[str, bool]:
        return (alpha, not marking)

    def __alpha_rule(self, markings: tuple[bool], alpha1: str, alpha2: str) -> tuple[tuple[str, bool]]:
        return (alpha1, markings[0]), (alpha2, markings[1])
    
    def __beta_rule(self, markings: tuple[bool], beta1: str, beta2: str) -> tuple[tuple[str, bool]]:
        return (beta1, markings[0]), (beta2, markings[1])